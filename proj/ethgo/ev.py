...
class Project:
    def __init__(self, id, pid, sponsor, title, cata, desc, pratio, modules, claimers, status, timestamp, mid, txhash, tchash):
        self.id = id
        self.pid = pid
...
def getProject(id, mid, txhash):
    try:
        ...
        id, pid, sponsor, title, cata, desc, pratio, modlen, clalen, status, timestamp = contract.functions.getProject(id).call()
        ...
        proj = Project(id, pid, sponsor, title, cata, desc, pratio, modules, claimers, status, timestamp, mid, txhash, txhash)
